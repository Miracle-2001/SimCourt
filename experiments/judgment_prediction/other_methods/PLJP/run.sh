...
python llm_api.py --model "deepseek_v3_0324" --small_model CNN --task article --use_split_fact True --dataset "cail18"
python llm_api.py --model "deepseek_v3_0324" --small_model CNN --task charge --use_split_fact True --dataset "cail18"
python llm_api.py --model "deepseek_v3_0324" --small_model CNN --task penalty --use_split_fact True --dataset "cail18"