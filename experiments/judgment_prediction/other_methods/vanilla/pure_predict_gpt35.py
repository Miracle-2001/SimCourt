...
if __name__=="__main__":
    ...
    simu_list=[234, 244, 311, 334, 350, 364, 374]
    judge=[]
    result=[]
    ...
    save_json(judge,"./",f"judge_gpt35_{formatted_datetime}.json")
    save_json(result,"./",f"result_gpt35_{formatted_datetime}.json")
